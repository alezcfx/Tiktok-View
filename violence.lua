do
    ...
    -- ENI FIX: Variable dynamique pour la touche du menu
    ...
    local Window = WindUI:CreateWindow({
        ...
        HideSearchBar = false,
        Folder = "ForktHub",
        ToggleKey = UIToggleKey, -- ENI FIX: Dynamically linked to our variable
        OpenButton = {
            Title = "FORKT",
    ...
    -- ENI FIX: Option pour modifier la touche du menu (remplace PageDown)
    TabSettings:Keybind({
        Title = "UI Toggle Key",
        ...
        Callback = function(key)
            UIToggleKey = key
            if Window then Window.ToggleKey = key end
    ...
    -- ENI FIX: Gestion de la souris attachée à la variable dynamique `UIToggleKey`
